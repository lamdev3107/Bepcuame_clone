			...
			<div class="col-xs-12 col-sm-6">
				<div class="order-details padding60">
					...
					<div class="por-dse clearfix">
						<ul>
							<li><span>Tên KH:<strong>:</strong></span> <?php echo $_SESSION['user']['Ho']. " " .$_SESSION['user']['Ten']?></li>
							<li><span>Email<strong>:</strong></span> <?=$_SESSION['user']['Email']?></li>
							<li><span>Số ĐT<strong>:</strong></span> <?=$_SESSION['user']['SDT']?></li>
						</ul>
					</div>
				</div>
				<div class="order-address bill padding60">
					...
					<p><?=$_SESSION['user']['DiaChi']?></p>
					<p>Phone: <?=$_SESSION['user']['SDT']?></p>
					<p>Email: <?=$_SESSION['user']['SDT']?></p>
				</div>
			</div>
		</div>
	</div>
